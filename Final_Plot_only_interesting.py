...
def main():
    ...
    output_file = 'ISM_f35h35_50ML_nptg120_1000Y_100_12_1_1_1.txt'
...
def plot_retention_by_formation(filenames):
    ...
    formation_temps = [10, 20, 30, 35, 40, 45] 
    formation_styles = ['-', '--', 'dotted', 'dashdot', (0,(3,1,1,1,1,1)), '-']  # solid, dashed, dash-dot
    formation_style_map = dict(zip(formation_temps, heating_colors))
    ...
    for filename in filenames:
        ...
        color = formation_style_map[f_temp]
...
plot_retention_by_formation(
    [
     ...
     'ISM_f35h35_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f40h40_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f45h45_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     ]
)