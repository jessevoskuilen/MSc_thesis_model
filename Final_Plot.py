...
def main():
    ...
    output_file = 'ISM_f50h40_50ML_nptg120_1000Y_100_12_1_1_1.txt'
...
def extract_fh_from_filename(filename):
    match = re.search(r"ISM_f(\d+)h(\d+)", filename)
    return int(match.group(1)), int(match.group(2)) if match else (None, None)

def load_data(filename):
    data = np.loadtxt(filename, skiprows= 3 if (match := re.search(r'f(\d+)h(\d+)', filename)) and match.group(1) == match.group(2) else 4
)
    if data.ndim == 1:
...
def plot_retention_by_formation(filenames):
    ...
    for kr, xe, label, fc, ec, marker, size in ref_points:
        ...
        if label == 'Solar':
            ...
            y=0.78
        ax.text(kr * x, xe * y, label, fontsize=18, ha='right', color=ec if fc != 'white' else 'black')
    ...
    heating_colors = plt.cm.coolwarm(np.array(np.linspace(0.15,0.75,4)))
    heating_color_map = dict(zip(heating_temps, heating_colors))
    
    # --- Define linestyle mapping for formation temperatures ---
    formation_temps = [10, 20, 30, 40]
    formation_styles = ['-', '--', 'dotted', 'dashdot']  # solid, dashed, dash-dot
    ...
    for filename in filenames:
        ...
        if f_temp == 10 and h_temp == 40:  # Check if this is the f10h40 dataset
            ...
            ax.text(center_kr, center_xe, '1000<t<4000 yr', 
                    color='white',
                    fontsize=18, 
                    rotation=angle_deg-2,
                    ha='center', 
                    va='center',
                    zorder=15)
    ...
    ax.set_xscale('log')
    ax.set_yscale('log')
    ax.set_xlabel("Kr / Ar", labelpad=0)
    ax.set_ylabel("Xe / Ar", labelpad = 0)
    ax.xaxis.set_major_locator(LogLocator(base=10))
    ax.yaxis.set_major_locator(LogLocator(base=10))
    ax.grid(True, alpha=0.0, linestyle=':')

    formation_temps = [10, 20, 30, 40]
    formation_colors = plt.cm.coolwarm(np.array(np.linspace(0.1,0.75,4)))
    ...
    ax.tick_params(axis='both', which='minor', length=4, width=1, color='gray', direction='out')   
    ax.minorticks_on()
    ...
    for info in polygon_info:
        ...
        if in_zoom:
            ...
            # Also add the scatter points
     #       ax.scatter(kr_data, xe_data, 
      #                   facecolor=info["facecolor"], 
      #                   edgecolor='black', 
       #                  s=40, zorder=3, linewidth=0.8)
    ...
    plt.subplots_adjust(left=0.13, right=0.99, top=0.99, bottom=0.2)
    plt.show()
# Call the final plotting function the same way:
#main()
plot_retention_by_formation(
    [
     'ISM_f10h40_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f10h10_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f10h20_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f20h20_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f10h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f20h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f30h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f50h10_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f50h20_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f50h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f40h10_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f40h20_50ML_nptg120_1000Y_100_12_1_1_1.txt',
   #  'ISM_f40h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
 #    'ISM_f60h10_50ML_nptg120_1000Y_100_12_1_1_1.txt',
 #    'ISM_f60h20_50ML_nptg120_1000Y_100_12_1_1_1.txt',
 #    'ISM_f60h30_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f20h40_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f30h40_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     'ISM_f40h40_50ML_nptg120_1000Y_100_12_1_1_1.txt',
     ]
)